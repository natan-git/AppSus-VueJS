...
const API_KEY = 'AIzaSyDQeu_p5kIVVb91OERSc6497DYbJeQDXT0';
...
function getBooksByTxt(txt) {
  return axios.get(`https://www.googleapis.com/books/v1/volumes?q=${txt}&maxResults=12&filter=full&key=${API_KEY}`)
    .then(books => {
      console.log('books:', books);
      let booksFound = []
      books.data.items.forEach(bookObj => {
